...
const de = {
  ...
  menu: {
    ...
    difficulty: {
      ...
      medium: 'Mittel',
      hard: 'Schwer',
      easyDescription: 'Zufällige Züge, wenig Strategie',
      mediumDescription: 'Grundlegende Strategie, schlechte Karten vermeiden',
      hardDescription: 'Fortgeschrittene Strategie, Bluff, Risikobewertung',
    },
  ...
  game: {
    ...
    aceEffect: 'Ass-Effekt',
    aceEffectDescription: 'Schaue dir die obersten 3 Karten des Decks an und tausche optional eine davon mit einer deiner Handkarten.',
    aceRevealedCards: 'Aufgedeckte Karten:',
    aceChooseHandCard: 'Wähle eine deiner Handkarten zum Tauschen:',
    aceEffectUsed: 'Ass-Effekt eingesetzt!',
    tenEffectUsed: 'Zehn-Effekt eingesetzt! Der nächste Spieler wird übersprungen.',
...
const en = {
  ...
  menu: {
    ...
    difficulty: {
      ...
      medium: 'Medium',
      hard: 'Hard',
      easyDescription: 'Random moves, little strategy',
      mediumDescription: 'Basic strategy, avoids bad cards',
      hardDescription: 'Advanced strategy, bluffing, risk assessment',
    },
  ...
  game: {
    ...
    aceEffect: 'Ace Effect',
    aceEffectDescription: 'Look at the top 3 cards of the deck and optionally swap one with a card from your hand.',
    aceRevealedCards: 'Revealed cards:',
    aceChooseHandCard: 'Choose a hand card to swap:',
    aceEffectUsed: 'Ace effect used!',
    tenEffectUsed: 'Ten effect used! The next player is skipped.',
